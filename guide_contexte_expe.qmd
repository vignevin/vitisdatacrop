...
Les facteurs étudiés et leurs niveaux (ou modalités) sont décrits indépendamment du plan d'expérience (@tbl-metadata_factor).
...
#| tbl-cap: Métadonnées descriptives du suivi expérimental
